...
class BarcodeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        preview = Preview.Builder()
            .build()
            .also { it.setSurfaceProvider(findViewById<PreviewView>(R.id.barcodeViewFinder).surfaceProvider) }
...
//        findViewById<ImageView>(R.id.camera_capture_button).setOnClickListener { takePhoto() }
    ...
    private class BarcodeAnalyzer(
        ...
        override fun analyze(image: ImageProxy) {
            ...
            Log.d(TAG, "w ${image.width}, h ${image.height}, r ${image.imageInfo.rotationDegrees}")
            ...
            try {
                val result = formatReader.decode(binaryBitmap)
